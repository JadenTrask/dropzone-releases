...
function scheduleCount(){clearInterval(timer);if(active&&!document.hidden){refresh();timer=setInterval(refresh,60000);}}
document.addEventListener('visibilitychange',scheduleCount);
