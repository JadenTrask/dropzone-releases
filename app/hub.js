...
async function route(id,watchGame=null,initialView=null){
  if(id==='command')id='home';if(id==='saved'){id='lol';initialView='saved';}
  const navigation=++navigationRevision;
  leaveIntel();leaveFinals();leaveWatch();leaveSources();leavePatches();leaveWardogs();leaveWardogsProgression();leaveSiege();leaveForest();
