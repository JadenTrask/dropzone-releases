...
async function route(id,watchGame=null,initialView=null){
  ...
  rememberWorkspace(id,['progression','damage','planner','squad','watch','patches'].includes(id)?state.watchGame:null);
